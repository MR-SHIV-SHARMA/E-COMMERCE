...
export default function Main() { // Main function ko export kar rahe hain
  return ( // JSX return kar rahe hain
    <>
      <div className="relative overflow-hidden h-[500px] lg:h-[600px] xl:h-[650px] w-full"> {/* Container div for carousel */}
        {/* Carousel Section */}
        <div className="relative h-[500px] lg:h-[600px] xl:h-[650px]"> {/* Carousel ki height set kar rahe hain */}
          <Carousel
          ...
          >
            ...
            <div className="relative h-[554px] sm:h-auto"> {/* Image container */}
              <img
          ...
          {/* Overlay Content */}
          <div className="absolute inset-0 flex flex-col justify-end text-center lg:text-left lg:items-start px-4 sm:px-6 md:px-8 lg:px-16 bg-gradient-to-t from-black via-transparent to-black"> {/* Overlay content ka styling */}
            <div className="flex flex-col sm:mb-20 sm:flex-row justify-between w-full lg:items-start "> {/* Content layout */}
              <div className=""> {/* Text container */}
                <h3 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-white drop-shadow-lg"> {/* Heading */}
                  Discover Your Style
                </h3>
                <p className="mt-2 text-sm sm:text-base md:text-lg lg:text-xl leading-6 sm:leading-7 md:leading-8 lg:leading-9 text-white drop-shadow-lg"> {/* Paragraph */}
      ...
      <div className="h-20 w-full bg-white flex items-center justify-center"> {/* Bottom section */}
        <h1 className="text-lg sm:text-xl md:text-2xl lg:text-3xl xl:text-4xl font-bold text-black drop-shadow-lg text-center"> {/* Heading */}
          Unleash Your Style with Our Exclusive Collection
        </h1>
      </div>

      {/* New Section */}
      <div className="relative bg-white text-black py-10 sm:py-12 md:py-16 lg:py-20 bg-cover bg-center bg-[url('/images/pexels-shvetsa-6593778.jpg')]"> {/* New section with background image */}
        <div className="absolute inset-0 bg-black opacity-25"></div> {/* Overlay for background image */}

        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 md:px-8 lg:px-8 text-center lg:text-left"> {/* Content container */}
          <h3 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-white"> {/* Heading */}
            Explore Our Collections
          </h3>
          <p className="mt-2 text-sm sm:text-base md:text-lg lg:text-xl leading-6 sm:leading-7 md:leading-8 lg:leading-9 text-white"> {/* Paragraph */}
            Find the perfect outfit for any occasion with our diverse range of
            styles.
          </p>
          <div className="mt-6 flex justify-center lg:justify-start"> {/* Button container */}
            <NavLink
              to="/ProductDetailPagePage" // Link destination
